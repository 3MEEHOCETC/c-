...
Directory is self-contained and portable, including all required tools:
 ...
 - raylib 5.5 library with source code, examples and several preconfigured projects
    > https://github.com/raysan5/raylib
 - Notepad++ 8.7.1 64bit (npp) 64bit preconfigured with some scripts to compile raylib and examples
    > https://github.com/notepad-plus-plus/notepad-plus-plus
 - w64devkit 2.0.0 (GCC 14.2.0 - 64bit), portable C and C++ Development Kit for Windows
    > https://github.com/skeeto/w64devkit
 - emsdk 3.1.71 - Emscripten C compiler for WebAssembly
    > https://github.com/emscripten-core/emsdk

A "Notepad++ for raylib" shortcut is created on desktop on installation and when the program is first opened, 
...
open source with permissive licenses for redistribution. 
 ...
 - emsdk is licensed as MIT:
    > https://github.com/emscripten-core/emsdk/blob/main/LICENSE

*Check raylib/w64devkit/COPYING.MinGW-w64-runtime.txt for additional license details
for the multiple components included in the MinGW-w64 package.
